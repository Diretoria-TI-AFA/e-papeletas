...
const Comando = () => {
  return (
    <section className='h-screen w-screen' style={{ backgroundImage: "url('/fundo_app.png')",backgroundSize: "100% auto",backgroundPosition: "top center", backgroundRepeat: "no-repeat" }}>
